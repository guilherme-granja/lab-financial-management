        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {databases.map((db) => (
            <button
              ...
              className={`text-left bg-[#1a1d27] border border-[#2d3148] border-l-4 ${HEALTH_BORDER[db.health]} rounded-xl p-4 hover:bg-[#20232f] transition-colors`}
            >
